...
ALTER TABLE "EXPERIMENT" ADD CONSTRAINT "EXPERIMENT_FK_DATASET" FOREIGN KEY ("REP_NUM", "NAMEDATASET")
REFERENCES "REPETICIO" ("NUM", "NAMEDATASET") ON DELETE CASCADE ENABLE;
