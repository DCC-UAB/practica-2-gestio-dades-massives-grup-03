...
(
    "VALORS" CLOB -- Se asume que se almacenan datos JSON como CLOB
);

CREATE UNIQUE INDEX "PARAMETRES_PK" ON "PARAMETRES" ("VALORS, NOMCURT");
...
(
    "NUM" NUMBER NOT NULL,
    CONSTRAINT "REPETICIO_PK" PRIMARY KEY ("NAMEDATASET")
);
...
REFERENCES "DATASET" ("NAMEDATASET") ON DELETE CASCADE ENABLE;
